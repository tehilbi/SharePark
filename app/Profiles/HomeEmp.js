...
export default class HomeEmp extends Component{
    ...
    async parking2(){
        const res = await fetch('http://172.20.4.94:3000/parkingSpots2',{
            method:'POST',
            headers:{
                'Accept':'application/json',
                'Content-Type':'application/json',
    ...
    async parking3(){
        const res = await fetch('http://172.20.4.94:3000/parkingSpots3',{
            method:'POST',
            headers:{
                'Accept':'application/json',
                'Content-Type':'application/json',
    ...
    async parking4(){
        const res = await fetch('http://172.20.4.94:3000/parkingSpots4',{
            method:'POST',
            headers:{
                'Accept':'application/json',
                'Content-Type':'application/json',
