...
export default class SettingsScreenEmpWithParking extends Component{
    ...
    async parking1(){
        const res = await fetch('http://192.168.1.118:3000/parkingSpots1',{
            method:'POST',
            headers:{
    ...
    async parking2(){
        const res = await fetch('http://192.168.1.118:3000/parkingSpots2',{
            method:'POST',
            headers:{
                'Accept':'application/json',
                'Content-Type':'application/json',
    ...
    async parking3(){
        const res = await fetch('http://192.168.1.118:3000/parkingSpots3',{
            method:'POST',
            headers:{
                'Accept':'application/json',
                'Content-Type':'application/json',
    ...
    async parking4(){
        const res = await fetch('http://192.168.1.118:3000/parkingSpots4',{
            method:'POST',
            headers:{
                'Accept':'application/json',
                'Content-Type':'application/json',
    ...
    release=()=>
    {
        fetch('http://192.168.1.118:3000/updateParkingSpot',{
        method:'POST',
        headers:{
            'Accept':'application/json',
            'Content-Type':'application/json',
